...
no single source for an answer. Learning by doing is also risky, since beginners' mistakes cost real money. Likewise with fitness, it can be daunting to get started, so many different muscle groups, what is cardio, what is leg day, etc.
