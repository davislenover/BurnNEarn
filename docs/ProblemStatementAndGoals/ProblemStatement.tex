...
In this section, we identify the stakeholders of FitFolio and their roles and interests in the project. \\
\begin{tabular}{p{0.35\textwidth} p{0.55\textwidth}}
\toprule
\textbf{Stakeholder} & \textbf{Role / Interest} \\
\midrule
Beginner Investors / Fitness-Motivated Users & Primary users who track activity, earn virtual currency, and manage a virtual portfolio; want an engaging, easy-to-understand way to build habits and learn investing without real financial risk. \\
Friends / Social Connections &  Secondary users who view shared workouts and portfolio metrics; expect to see only what users choose to share. \\
Project Supervisor / TA (Chris Schankula) &  \\
Course Instructor &  \\
Development Team &  Designs, builds, tests, and documents FitFolio; aims to deliver a working product within the academic timeline.\\
Health Platform Providers (Apple HealthKit, Google Health Connect) &  \\
Market Data Providers &  \\
App Stores / Privacy Regulators (PIPEDA) & Set rules for handling health data and financial content that the app must follow.  \\
\bottomrule
\end{tabular}
