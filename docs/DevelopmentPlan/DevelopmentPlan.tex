...
\bottomrule
\end{tabular}
\caption{Major project deadlines from the course outline}
\label{tab:schedule}
\end{table}
\newpage{}
...
The team plans to use Artificial Intelligence (AI) and Large Language Models (LLMs) to help with both code and documentation development throughout the FitFolio project. When working on code we may use them to explain unfamiliar libraries, compare possible approaches, understand error messages, and suggest fixes or test cases. Team members will review these suggestions and decide whether they fit the project. For the documentation of this project, we may use LLMs to brainstorm ideas, organize sections, improve unclear wording, and identify missing information or contradictions. The final content will reflect our team's decisions and the work we have actually completed.

We plan to use ChatGPT and Claude for these tasks. Team members may use either tool depending on what they need help with. For example, someone might will use ChatGPT to understand an error message or Claude to review a section of code. We will record the tools and model versions used where available along with any AI assistance that meaningfully contributes to each deliverable. 

Before a team member including AI code, the team member will read it and understand how it works, and then check that it meets the intended requirements for the project. We will run relevant tests which including normal cases and situations where inputs are missing or invalid. For example, code that calculates fitness rewards or virtual portfolio values will be checked using inputs with known expected results. We will also check claims about libraries and services against their documentation. For written contents, we will check factual claims and references against the original sources and make sure the text agrees with our project scope and team decisions. Changes will go through teammate review in a pull request before being merged. We will correct or remove any suggestions that we cannot verify.  
