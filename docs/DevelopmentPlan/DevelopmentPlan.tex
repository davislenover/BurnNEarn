...
The primary target operating systems for this app will be Android 17 and iOS 28 this is due to the nature of the testing equipment available
for all group members and supervisor.

\subsubsection{Languages}
It is expected that React Native will be used for the front-end. This will allow the team to write code that works on both platforms at once.
The backend will consist of Python mainly for its rich and optimal library support for the tasks the app may need to perform (ex, fetching stock data over the web).
...
For the tests themselves, they will be developed overtime and integrated into the suite as seen fit. Justification must be provided for any new test cases.
